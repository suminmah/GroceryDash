...
<div class="admin-container" style="max-width: 900px; margin: 0 auto; padding: 20px;">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        <h2>Provision New Separated Profile</h2>
        <a href="<?= APP_URL ?>/admin/customers" style="text-decoration: none; color: #4b5563;">⬅️ Back to Directory</a>
    </div>
    ...
    <form action="<?= APP_URL ?>/admin/customers" method="POST" style="background: white; padding: 25px; border: 1px solid #e5e7eb; border-radius: 8px; display: flex; flex-direction: column; gap: 20px;">
        ...
        <div style="border-bottom: 1px solid #f3f4f6; padding-bottom: 10px; font-weight: bold; color: #1f2937;">👤 Real-World Demographics Profile</div>
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
            <div>
                <label style="display:block; margin-bottom:5px; font-size:13px; font-weight:600;">Customer Full Name</label>
                <input type="text" name="name" style="width:100%; padding:8px; border:1px solid #d1d5db; border-radius:4px;" placeholder="e.g. Rohan Maharjan" required>
            </div>
            <div>
                <label style="display:block; margin-bottom:5px; font-size:13px; font-weight:600;">Mobile Phone Number</label>
        ...
        <div style="border-bottom: 1px solid #f3f4f6; padding-bottom: 10px; font-weight: bold; color: #1f2937;">🔒 System Authentication Account Credentials</div>
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
            <div>
                <label style="display:block; margin-bottom:5px; font-size:13px; font-weight:600;">Electronic Login Email</label>
                <input type="email" name="email" style="width:100%; padding:8px; border:1px solid #d1d5db; border-radius:4px;" placeholder="rohan@grocerydash.com" required>
            </div>
            <div>
                <label style="display:block; margin-bottom:5px; font-size:13px; font-weight:600;">Account Access Password</label>
        ...
        <div>
            <label style="display:block; margin-bottom:5px; font-size:13px; font-weight:600;">Authorization Access Role</label>
