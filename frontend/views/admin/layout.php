    ...
    <div class="admin-dashboard-layout d-flex">
        <aside class="col-md-3 col-lg-2 bg-light vh-100 p-3">
            ...
            <ul class="nav nav-pills flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= str_contains($_SERVER['REQUEST_URI'], 'admin/users') ? 'active bg-success text-white' : 'text-dark' ?>" 
                ...
                <li class="nav-item">
                    <a class="nav-link <?= str_contains($_SERVER['REQUEST_URI'], 'customers') && !str_contains($_SERVER['REQUEST_URI'], 'admin/users') ? 'active bg-success text-white' : 'text-dark' ?>" 
